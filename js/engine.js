...
const RECO_REASON={
  combo:`## 債券＋基金搭配可能是適合您的方向
您希望兩者兼顧、想要搭配著看，債券＋基金的組合正好能同時兼顧穩定配息與成長潛力。

- **債券部位**：提供相對穩定的配息與明確到期時間，是這筆資金的穩定基礎
- **基金部位**：參與市場整體成長機會，長期潛力通常高於定存或債券，但淨值會隨市場波動
- **搭配的用意**：兩者漲跌不會完全同步，用債券分散基金的波動風險，同時保留成長彈性

實際比例會依您的使用時間與風險承受度調整，等一下的試算也能讓您自行拖動拉桿微調。`
};
