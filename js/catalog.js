...
const CATALOG=[
  ...
  {code:'FUND4',cat:'fund',name:'匯豐ESG永續多元資產組合基金',currency:'台幣／美元等',rate:0.035,rate1y:0.035,rate3y:0.032,
    ...
    managerInfo:'匯豐投信發行的組合型基金（投資其他基金的 FOF），投資於具 ESG／永續特色的子基金，跨股債多元資產配置，設有配息與不配息級別，透過子基金分散但仍受市場波動影響。'},
...
/* 債券商品詳情頁共用的發行機構風險提示，附加在個別 issuerInfo 之後 */
const BOND_ISSUER_DISCLAIMER='以上皆為公司（金融）債，主要收益來自票息，須留意利率、信用（發行人違約）及非台幣計價的匯率等風險；實際條件依各檔票息、到期日與債信評等而定。';
